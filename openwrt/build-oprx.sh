...
# github mirror
if [ "$isCN" = "CN" ]; then
    export github="ghfast.top/github.com"
...
#git clone --depth=1 https://$github/ilxp/lede -b $branch openwrt
...
src-git luci https://$github/coolsnowwolf/luci.git;openwrt-23.05 #25.12分支luci的upnp有问题
