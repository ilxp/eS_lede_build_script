...
merge_package main https://github.com/openwrt/openwrt.git package/devel package/devel/perf
...
merge_package master https://github.com/openwrt/packages.git packages/libs libs/libssh libs/libmbim
